  ...
  <body>
    ...
    <div class="container-fluid pt-5">
      <div class="container">
        ...
        <div class="row pb-3">
          <div class="col-lg-4 mb-4"  data-aos="fade-right" data-aos-delay="300" data-aos-duration="1100">
            <div class="card border-0 shadow-sm mb-2">
              <img class="card-img-top mb-2" src="img/blog1.jpg" alt="" />
              <div class="card-body bg-light text-center p-4">
                <h4 class="">Apa Itu Kecerdasan Emosional?</h4>
                <p>
                  Kecerdasan emosional adalah kemampuan seseorang untuk
                  mengenali, memahami, dan mengelola emosinya sendiri serta
                  memahami emosi orang lain.
                </p>
                <a
                  href="https://www.ruangkerja.id/blog/pentingnya-emotional-intelligence-di-dunia-pekerjaan "
          ...
          <div class="col-lg-4 mb-4"  data-aos="fade-down" data-aos-delay="300" data-aos-duration="1100">
            <div class="card border-0 shadow-sm mb-2">
              <img class="card-img-top mb-2" src="img/blog2.jpg" alt="" />
              <div class="card-body bg-light text-center p-4">
                <h4 class="">Apa Itu Pengetahuan umum ?</h4>
                <p>
                  Pengetahuan umum adalah wawasan dasar tentang berbagai hal
                  yang bermanfaat untuk diketahui oleh semua orang. Hal ini juga
                  membantu anak dalam meningkatkan pemahaman dan prestasi pada
                  anak.
                </p>
                <a
                  href="https://penerbitbmedia.com/pentingnya-pengetahuan-umum-untuk-siswa-sekolah-dasar/"
                  class="btn btn-primary px-4 mx-auto my-2"
                  >Read More</a
                >
              </div>
          ...
          <div class="col-lg-4 mb-4"  data-aos="fade-left" data-aos-delay="300" data-aos-duration="1100">
            <div class="card border-0 shadow-sm mb-2">
              <img
                class="card-img-top mb-2"
                src="img/What is Empathy .png"
                alt=""
              />
              <div class="card-body bg-light text-center p-4">
                <h4 class="">
                  Pengertian Empati: Ciri-Ciri, Faktor, dan Fakta Empati
                </h4>
                <p>
                  Empati adalah kemampuan memahami dan merasakan emosi orang
                  lain. Ciri-cirinya meliputi kepekaan dan perhatian,
                  dipengaruhi oleh pengalaman dan lingkungan. Empati penting
                  untuk membangun hubungan kuat dan kerjasama yang baik.
                </p>
                <a
                  href="https://www.gramedia.com/literasi/empati/"
                  class="btn btn-primary px-4 mx-auto my-2"
                  >Read More</a
                >
              </div>
