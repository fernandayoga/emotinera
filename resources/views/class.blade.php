  ...
  <body>
      ...
      >
        ...
        >
          <div class="navbar-nav font-weight-bold mx-auto py-0">
            ...
            <a href="{{ url('/class') }}" class="nav-item nav-link active">Classes</a>
    ...
    <div class="container-fluid pt-5">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 mb-5" data-aos="fade-down-right" data-aos-delay="300" data-aos-duration="1100">
            <div class="card border-0 bg-light shadow-sm pb-2">
              <img
                class="card-img-top mb-2"
                src="img/Kesadaran Diri.PNG"
                alt=""
              />
              <div class="card-body text-center">
                <h4 class="card-title">Kesadaran Diri</h4>
                <p class="card-text">
          ...
          <div class="col-lg-4 mb-5" data-aos="fade-down" data-aos-delay="300" data-aos-duration="1100">
            <div class="card border-0 bg-light shadow-sm pb-2">
              <img
                class="card-img-top mb-2"
                src="img/Pengembangan Diri.PNG"
                alt=""
              />
              <div class="card-body text-center">
                <h4 class="card-title">Pengelolaan Diri</h4>
                <p class="card-text">
          ...
          <div class="col-lg-4 mb-5" data-aos="fade-down-left" data-aos-delay="300" data-aos-duration="1100">
            <div class="card border-0 bg-light shadow-sm pb-2">
              <img
                class="card-img-top mb-2"
                src="img/Motivasi Diri.PNG"
                alt=""
              />
              <div class="card-body text-center">
                <h4 class="card-title">Motivasi Diri</h4>
                <p class="card-text">
          ...
          <div class="col-lg-4 mb-5" data-aos="fade-up-right" data-aos-delay="300" data-aos-duration="1100">
            <div class="card border-0 bg-light shadow-sm pb-2">
              <img class="card-img-top mb-2" src="img/Empati.PNG" alt="" />
              <div class="card-body text-center">
                <h4 class="card-title">Empati</h4>
                <p class="card-text">
                  Motivasi diri adalah dorongan internal yang menjaga semangat
          ...
          <div class="col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1100">
            <div class="card border-0 bg-light shadow-sm pb-2">
              <img
                class="card-img-top mb-2"
                src="img/Keterampilan Sosial.PNG"
                alt=""
              />
              <div class="card-body text-center">
                <h4 class="card-title">Keterampilan Sosial</h4>
                <p class="card-text">
          ...
          <div class="col-lg-4 mb-5" data-aos="fade-up-left" data-aos-delay="300" data-aos-duration="1100">
            <div class="card border-0 bg-light shadow-sm pb-2">
              <img
                class="card-img-top mb-2"
                src="img/Pengetahuan Umum.PNG"
                alt=""
              />
              <div class="card-body text-center">
                <h4 class="card-title">Pengetahuan Umum</h4>
                <p class="card-text">
